                ...
                <?php
                    ...
                    <div id="profile_background">
                        ...
                        <div id="profile_content">
                            ...
                            <a class="profile_content_menu_button" href="users.php"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user" width="44" height="44" viewBox="0 0 24 24" stroke-width="2" stroke="#545454" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
